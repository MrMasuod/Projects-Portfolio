...
void main() {
    ...
    setupTimer();
    setup();
    Timer_val_min = (uint16_t)(16384 * 0.05);
    Timer_val_max = (uint16_t)(16384 * 0.95);
    Measured_Period = (unsigned long)(1e6/50);
    while(1) {
        GetTimerVal();
        _Bool is_overflow_timer = (Tmi[0]< Timer_val_min || Tmi[1]< Timer_val_min || Tmi[0] > Timer_val_max || Tmi[1] > Timer_val_max);
